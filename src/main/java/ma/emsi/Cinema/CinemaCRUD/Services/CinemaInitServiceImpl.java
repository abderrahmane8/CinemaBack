...
public class CinemaInitServiceImpl implements ICinemaInitService {
    ...
    public void initVilles() {
        Stream.of("Casablanca", "Marrakech", "Rabat", "Tanger","Agadir" , "Asfi", "Mogador" , "Fes").forEach(nameVille -> {
    ...
    public void initCinema() {
        villeRepository.findAll().forEach(v -> {
            Stream.of("MEGARAMA", "IMAX", "SAADA", "CHAHRAZAD","JamoussiCinema" ," CRUDCINEMAS ").forEach(nameCinema -> {
    ...
    public void initFilms() {
        ...
        Stream.of("Film 1", " Film 2", " Film 3 ", "Film 4")
                .forEach(titre -> {
                    Film film = new Film();
                    film.setTitre(titre);
